...
type Tour struct {
	...
	Gallery        pq.StringArray `gorm:"type:text[]" json:"gallery"`   // You can use a proper media struct if needed
	Itinerary      pq.StringArray `gorm:"type:text[]" json:"itinerary"` // Simplify or use JSONB
